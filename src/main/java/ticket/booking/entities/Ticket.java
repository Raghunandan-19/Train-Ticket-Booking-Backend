...
public class Ticket {
    ...
    public static class TicketBuilder {
        ...
        public TicketBuilder source(String source) {
            this.source = source;
            return this;
        }
        ...
        public TicketBuilder dateOfTravel(String dateOfTravel) {
            this.dateOfTravel = dateOfTravel;
            return this;
        }
        ...
        public Ticket build() {
            return new Ticket(ticketId, userId, source, destination, dateOfTravel, train);
        }
    }
